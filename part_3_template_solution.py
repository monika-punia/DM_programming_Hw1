...
class Section3:
    ...
    def partB(
        ...
        frac_to_remove = 0.9
        X, y = nu.remove_9s_convert_to_01(X, y, frac=frac_to_remove)
        Xtest, ytest = nu.remove_9s_convert_to_01(
    ...
    def partD(
        ...
        answer["explain_purpose_of_class_weights"] = "Explanatory text"
        answer["explain_performance_difference"] = "Explanatory text"
        return answer
